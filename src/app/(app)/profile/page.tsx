...
export default function ProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-0 py-4">
      {/* ── PAGE HEADER ────────────────────────────────────────────── */}
      <div className="border-b border-[rgba(255,255,255,0.06)] pb-4 fade-up mb-8">
      ...
      <div className="mt-12 mb-8">
        <div className="flex items-center gap-3">
          ...
          <span
            ...
            style={{ color: "var(--ink-low)", fontSize: 9, letterSpacing: "0.25em" }}
          >
            PERFORMANCE DATA
          </span>
          <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.06)" }} />
