...
// library is split out of the initial bundle.
...
// ============================================================================
// LiveClock — ticking monospace HH:MM
// ============================================================================
function LiveClock() {
...
function KPIPanel({ label, value, subValue, panelNum, accent = "orange" }: KPIPanelProps) {
  const accentColors = {
...
// ============================================================================
// ProgressDashboard — full stats readout, embeddable in any page
// ============================================================================
export function ProgressDashboard() {
  ...
  // -- Error state --
  if (isError) {
    return <SignalLost onRetry={handleRetry} t={t} />;
  }
    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-[#2a2a2a] pb-4">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div>
            <h2
              className="text-2xl font-extrabold uppercase tracking-tight text-[#e5e5e5]"
